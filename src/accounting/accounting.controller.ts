...
export class AccountingController {
    ...
    @ApiOperation({ summary: 'POST - Buy an item. Requires an item id passed in the URI. No response returned.'})
    @UseGuards(AuthGuard)
    @Post("buy/:itemId")
    ...
    @ApiOperation({ summary: 'POST - Sell an item. Requires and item id and a price passed in the URI. No response returned.' })
    @UseGuards(AuthGuard)
    ...
    @ApiOperation({ summary: 'GET - Returns "Array<BoughtItem>"' })
    @UseGuards(AuthGuard)
    @Get("bought")
    ...
    @ApiOperation({ summary: 'GET - Returns "Array<SoldItem>"' })
    @UseGuards(AuthGuard)
    @Get("sold")
    async getSoldItems(){ 
